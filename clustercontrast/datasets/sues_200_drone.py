...
class sues_drone(BaseImageDataset):
    ...
    def __init__(self, root, altitude, logger=None, verbose=True, **kwargs):
        ...
        if verbose:
            logger.info("=> SUES-200 drone loaded")

...
class Configuration:
    def __init__(self):
        parser = argparse.ArgumentParser(description='Test on University-1652')
        ...
        parser.add_argument('--ckpt_path',
                            default='/data1/chenqi/UniABC/checkpoints/university/convnext_base.fb_in22k_ft_in1k_384/1117140605/weights_e1_0.9320.pth',
        ...
        parser.add_argument('--gpu_ids', default=(6, 7), type=tuple)
        ...
        parser.add_argument('--data_folder', default=r'', type=str)
        ...
        parser.add_argument('--checkpoint_start', default="/data1/chenqi/DAC/checkpoints/university/convnext_base.fb_in22k_ft_in1k_384/0804214940/weights_e1_0.9190.pth")
...
if __name__ == '__main__':
    ...
    # drone_path = "/data0/chenqi_data/University-Release/train/drone"
    # satellite_path = "/data0/chenqi_data/University-Release/train/satellite"
    # tsne_visualization(model, drone_path, satellite_path, num_locations=50, samples_per_loc_drone=30, samples_per_loc_satellite=1)
